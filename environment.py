...
text_continue = font3.render("Press Enter to continue!", True, green)
text_play = menu_font.render("Play:", True, green)
text_music = menu_font.render("MUSIC", True, green)
text_sound = menu_font.render("SOUNDS", True, green)
